...
async def get_twitter_posts(company_name: str = Query(..., description="Company name to search tweets for")) -> dict:
...
@router.get("/reddit", operation_id="get_reddit_posts", response_model=RedditPostsResponse)
async def get_reddit_posts(company_name: str = Query(..., description="Company name to search reddit posts for")) -> dict:
...
@router.get("/news", operation_id="get_news_articles", response_model=NewsArticlesResponse)
async def get_news_articles(company_name: str = Query(..., description="Company name to search news articles for")) -> dict:
